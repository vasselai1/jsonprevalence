...
public class JoSqlListOperation <T extends PrevalenceEntity> extends JoSqlOperation<T> {

	public JoSqlListOperation(PrevalenceConfigurator prevalenceConfigurator, SequenceProvider sequenceUtil,MemoryCore memoryCore, FileCore fileCore) {
		super(prevalenceConfigurator, sequenceUtil, memoryCore, fileCore);
	}
	
	public JoSqlListOperation<T> set(Class<T> classe, String joSqlQuery, Map<String, Object> parametersBind) {
