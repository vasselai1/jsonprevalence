package br.org.pr.jsonprevayler.searchfilter.matchers;
...
* Copy of: https://github.com/nivance/image-similarity/blob/master/src/main/java/image/similarity/ImagePHash.java
*/
public class ImagePHashDistance {

	private int size = 32;
	private int smallerSize = 8;
	private double[] c;

	public ImagePHashDistance() {
		initCoefficients();
	}

	public ImagePHashDistance(int size, int smallerSize) {
		this.size = size;
